  ...
  <div class="wrapper">
    ...
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/dashboard/cliente" name="Clientes" icon="ti-user" />
        <sidebar-link to="/dashboard/venta" name="Ventas" icon="ti-view-list-alt" />
        <sidebar-link to="/dashboard/inventario" name="Inventario" icon="ti-view-list-alt" />
